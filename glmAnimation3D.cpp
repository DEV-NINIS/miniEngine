...
void glmAnimation3D::frameMatrix(GLuint shader) {
	...
	glUniformMatrix4fv(glGetUniformLocation(shader, "projectionPerspective"), 1, GL_FALSE, glm::value_ptr(this->getprojectionPerspectiveVARIABLE())); // frame projectionPerspective matrix variable
